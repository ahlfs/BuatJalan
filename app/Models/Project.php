...
class Project extends Model
{
    ...
    {
        return $this->hasMany(Roadmap::class)->orderBy('id');
    }

    public function dbSchemas(): HasMany
    {
        return $this->hasMany(DbSchema::class);
    }
    ...
    public function getLogoUrlAttribute(): ?string
    {
        ...
        foreach ($techStacks as $tech) {
            $nameLower = strtolower($tech->name);
