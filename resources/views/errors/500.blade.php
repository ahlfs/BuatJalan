...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="bg-zinc-950">
    <head>
        ...
        <title>Kesalahan Server Internal (500) - BuatJalan</title>
    ...
    <body class="bg-zinc-950 text-white min-h-screen font-sans antialiased overflow-hidden flex items-center justify-center relative p-6">
        ...
        {{-- Glow effects --}}
        <div class="absolute top-0 right-0 -mr-16 -mt-16 h-96 w-96 rounded-full bg-red-500/5 blur-3xl pointer-events-none"></div>
        ...
        <div class="w-full max-w-md flex flex-col items-center justify-center text-center relative z-10 space-y-8 animate-in fade-in zoom-in-95 duration-300">
            ...
            <div class="bg-zinc-900/30 border border-white/10 p-8 rounded-2xl shadow-2xl w-full flex flex-col items-center space-y-6">
                {{-- Huge Status Code --}}
                <div class="text-7xl font-extrabold tracking-widest text-red-500 font-mono select-none drop-shadow-[0_0_15px_rgba(239,68,68,0.15)]">
                    500
                </div>

                {{-- Status Text & Description --}}
                <div class="space-y-2">
                    <h2 class="text-lg font-bold text-white leading-snug">Kesalahan Server Internal</h2>
                    <p class="text-xs text-zinc-400 leading-relaxed max-w-xs mx-auto">
                        Oops! Terjadi kesalahan sistem tak terduga pada server kami. Tim pengembang kami sedang memperbaikinya secara otomatis. Silakan coba lagi nanti.
                    </p>
                </div>
            </div>
